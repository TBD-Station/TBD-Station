...
namespace Content.Shared.Medical.Components // Starlight moved to shared
{
    /// <summary>
    ...
    public sealed partial class HealingComponent : Component
    {
        ...
        [DataField]
        public bool SolutionDrain = false; // Starlight

        [DataField]
        public List<ReagentQuantity> ReagentsToDrain = new(); // Starlight
    }
}
