...
public partial class SharedBodySystem
{
    ...
    public bool TryGetFreePartSlot(EntityUid partId, [NotNullWhen(true)] out string? freeSlotId, BodyPartComponent? part = null) // Starlight
    {
        freeSlotId = null;
    ...
    public IEnumerable<string> TryGetFreePartSlots(EntityUid partId, BodyPartComponent? part = null) // Starlight
    {
        if (!Resolve(partId, ref part, logMissing: false))
            yield break;
