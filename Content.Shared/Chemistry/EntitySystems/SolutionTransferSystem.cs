...
public sealed class SolutionTransferSystem : EntitySystem
{
    ...
    public FixedPoint2 Transfer(EntityUid user,
        ...
        FixedPoint2 amount)
    {
        var transferAttempt = new SolutionTransferAttemptEvent(sourceEntity, targetEntity, source); // Starlight edit
...
/// </summary>
[ByRefEvent]
public record struct SolutionTransferAttemptEvent(EntityUid From, EntityUid To, Entity<SolutionComponent> SolutionEntity, string? CancelReason = null) // Starlight edit
{
    /// <summary>
